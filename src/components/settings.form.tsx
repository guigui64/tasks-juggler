...
import { DARK_THEME, LIGHT_THEME, THEME_STORAGE_KEY, SHOW_ORPHAN_STORAGE_KEY } from '../constants';

export const SettingsForm = ({ theme, setTheme, showOrphan, setShowOrphan }: any) => (
    <FormGroup style={{
